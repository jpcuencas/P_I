...
<link href="styleweb.css" rel="stylesheet" type="text/css" media="screen"/>
...
<div class="loged" id="loged">
	<fieldset class="flogin">
		...
		<div id="userloged" class="userloged">
			<label>Has entrado como: </label><div class="logedUser" id="logedUsr"><a id="logedas" href="pg/Usuario.html"> </a></div>
		</div>
...
<div class="menupriv display-great display-medium">
	<fieldset id="fmenupriv" class="fmenupriv">
		<ul>
			<li class="current_page_itempriv"><a href="pg/Usuario.php">Mis datos</a></li>
			<li><a href="#">Darme de baja</a></li>
			<li><a href="pg/Crearalbum.php">Crear album</a></li>
			<li><a href="pg/Album.php">Mis albumes</a></li>
			<li class="lastpriv"><a href="pg/Foto.php">A&ntilde;adir foto a album</a></li>
		</ul>
		
	</fieldset>

</div>
	<div class="menuminiuppriv display-mini">
	<label>Menu: </label><br>
		<select class="menuuppriv display-mini" onchange="javascript:changepagepriv()">
			<option>Mis datos</option>
			<option>Darme de baja</option>
			<option>Mis albumes</option>
			<option>Crear album</option>
			<option>A&ntilde;adir foto a album</option>
		</select>
	</div>
...
<div id="estilos" class="estilos">
	...
	<hr />
		<select id="menuminidown" class="menuminidown display-mini" onchange="javascript:changepagedw()">
			<option>Inicio</option>
			<option>Registro</option>
			<option>Busqueda</option>
		</select>
		...
		<label>Menu: </label>
		<select id="menurivdown" class="menudownpriv display-mini" onchange="javascript:changepagepriv()">
			<option>Mis datos</option>
			<option>Darme de baja</option>
			<option>Mis albumes</option>
			<option>Crear album</option>
