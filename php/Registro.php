...
<div class="pageRegistro" id="pageRegistro">
	...
	<div class="datos">
		...
		<div class="calloutUp"></div>
			<div class="calloutUp2">
				...
				<hr/>
					...
					-sólo puede contener letras del alfabeto inglés<br>
					-la longitud mínima 3 caracteres y máxima 15
					</p>
				<hr/>
			</div>
	</div>
		...
		<div class="calloutUp"></div>
			<div class="calloutUp2">
				<h3>La contraseña no es valida</h3>
				<hr/>
					<p>La contraseña debe rellenarse<br>
					-sólo puede contener letras del alfabeto inglés<br>
					números y el subrayado<br>
					-al menos debe contener una letra en mayúsculas,<br> 
					una letra en minúsculas y un número<br>
					-la lgongitud mínima 6 caracteres y máxima 15
					</p>
				<hr/>
			</div>
	</div>
		...
		<div class="calloutUp"></div>
			<div class="calloutUp2">
				<h3>Las contraseñas no coindicen</h3>
				<hr/>
					<p>Se debe escribir la misma contraseña en ambos lados</p>
				<hr/>
			</div>
	</div>
		</div>
...
-->
		...
		<div class="calloutUp"></div>
			<div class="calloutUp2">
				...
				<hr/>
					<p>
					-sólo puede contener números<br>
