...
<div id="estilos" class="estilos">
	...
	<hr />
		<select id="menuminidown" class="menuminidown display-mini" onchange="javascript:changepage();return false;">
	...
	<span id="contactodir" class="contacto">
		<label>Contacto: </label><a href="pg/Contacto.php"> jpcs1@alu.ua.es</a>
	</span>
</div>
