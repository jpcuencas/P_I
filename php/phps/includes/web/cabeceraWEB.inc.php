...
<div class="loged" id="loged">
	<fieldset class="flogin">
		...
		<div id="userloged" class="userloged">
			<label>has entrado como: </label><div class="logedUser" id="logedUsr"><a id="logedas" href="pg/Usuario.html?i=<?php echo(isset($_SESSION["uius"])?$_SESSION["uius"]:""); ?>"><?php echo(isset($_SESSION["NOMUsu"])?$_SESSION["NOMUsu"]:""); ?></a></div>
			<?php echo(isset($_SESSION["Msg"])?$_SESSION["Msg"]:""); ?>
		</div>
		<div id="exitloged" class="exitloged">
			<a href="/phps/includes/login/salir.php" onclick="javascript:salida_modificacss(); return false;">salir</a>
		</div>
	</fieldset>
</div>

<!-- action=" "-->
<form class="login" action="phps/loginpg.php" method="POST" name="f1">
